...
import Selenium.Monad (script, tryRepeatedlyTo, apathize)
...
dashboardScenario =
  scenario
    ...
    (apathize $ Interact.deleteFileInTestFolder "Dashboard.slam")
...
test =
  dashboardScenario "Make simple logo and chart dashboard" [] do
    ...
    Interact.wrapNthDeck 1
    Interact.moveNthDeckToLeftOfMthDeck 2 1
    Interact.resizeNthDeckAllTheWayToTheRightOfMthDeck 2 1

    Interact.insertNewDeckInLastDraftboard
    Interact.moveNthDeckToLeftOfMthDeck 3 1
    Interact.resizeNthDeckAllTheWayToTheRightOfMthDeck 3 1
    Interact.accessNextCardInNthDeck 3
    Interact.insertQueryCardInNthDeck 3
    ...
    Interact.accessNextCardInNthDeck 3
    Interact.insertVisualizeCardInNthDeck 3
